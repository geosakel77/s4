...
| Experiment Code | Algorithms | SRC | AgCTI | TA | DM                                  | IS | IA                 | Algo Config |
|-----------------|------------|-----|-------|----|-------------------------------------|----|--------------------|---------|
| 0               | QL,ES,DAC  | 2   | 1     | 1  | 1 x Prev<br/> 1 x Det <br/> 1 x Res | 3  | Random 3~10 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 }|
