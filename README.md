...
| Experiment Code | Algorithms | SRC | AgCTI | TA | DM                                  | IS | IA                 | Algo Config                                                                                                                                                          | Reward Config                                                                                                                | Other Exp. Conf                                                                              |
|-----------------|------------|-----|-------|----|-------------------------------------|----|--------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------|
| 0               | QL,ES,DAC  | 2   | 1     | 1  | 1 x Prev<br/> 1 x Det <br/> 1 x Res | 3  | Random 3~10 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 } | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=200 |
| 1               | QL,ES,DAC  | 3   | 1     | 1  | 1 x Prev<br/> 1 x Det <br/> 1 x Res | 5  | Random 3~10 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 } | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=200 |
| 2               | QL,ES,DAC  | 4   | 1     | 1  | 1 x Prev<br/> 2 x Det <br/> 2 x Res | 10 | Random 3~40 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 } | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=100 |
| 3               | QL,ES,DAC  | 5   | 1     | 1  | 2 x Prev<br/> 2 x Det <br/> 2 x Res | 10 | Random 3~40 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 } | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=50  |
| 4               | QL,ES,DAC  | 10  | 1     | 1  | 2 x Prev<br/> 2 x Det <br/> 2 x Res | 20 | Random 3~40 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 } | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=50  |
| 5               | QL,ES,DAC  | 10  | 1     | 1  | 2 x Prev<br/> 2 x Det <br/> 2 x Res | 20 | Random 3~40 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 } | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=10  |

### **Additional Experiments**

| Experiment Code | Algorithms | SRC | AgCTI | TA | DM                                  | IS | IA                 | Algo Config                                                                                                                                                            | Reward Config                                                                                                                | Other Exp. Conf                                                                             |
|-----------------|------------|-----|-------|----|-------------------------------------|----|--------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| a0              | QL,ES,DAC  | 2   | 1     | 1  | 1 x Prev<br/> 1 x Det <br/> 1 x Res | 3  | Random 3~10 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 }   | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=10 |
| a1              | QL,ES,DAC  | 2   | 1     | 1  | 1 x Prev<br/> 1 x Det <br/> 1 x Res | 3  | Random 3~10 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0.1,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 } | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=10 |
| a2              | QL,ES,DAC  | 2   | 1     | 1  | 1 x Prev<br/> 1 x Det <br/> 1 x Res | 3  | Random 3~10 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0.2,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 } | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=10 |
| a3              | QL,ES,DAC  | 2   | 1     | 1  | 1 x Prev<br/> 1 x Det <br/> 1 x Res | 3  | Random 3~10 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0.3,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 } | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=10 |
| a4              | QL,ES,DAC  | 2   | 1     | 1  | 1 x Prev<br/> 1 x Det <br/> 1 x Res | 3  | Random 3~10 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0.4,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 } | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=10 |
| a5              | QL,ES,DAC  | 2   | 1     | 1  | 1 x Prev<br/> 1 x Det <br/> 1 x Res | 3  | Random 3~10 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0.5,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 } | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=10 |
| a6              | QL,ES,DAC  | 2   | 1     | 1  | 1 x Prev<br/> 1 x Det <br/> 1 x Res | 3  | Random 3~10 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0.6,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 } | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=10 |
| a7              | QL,ES,DAC  | 2   | 1     | 1  | 1 x Prev<br/> 1 x Det <br/> 1 x Res | 3  | Random 3~10 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0.7,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 } | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=10 |
| a8              | QL,ES,DAC  | 2   | 1     | 1  | 1 x Prev<br/> 1 x Det <br/> 1 x Res | 3  | Random 3~10 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0.8,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 } | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=10 |
| a9              | QL,ES,DAC  | 2   | 1     | 1  | 1 x Prev<br/> 1 x Det <br/> 1 x Res | 3  | Random 3~10 per IS | {"num_actions": 2,"epsilon": 0.1,"gamma": 0.99,"alpha": 0.1,"seed": 0.9,"state_vector_size": 49,"alpha_pi":1e-2,"alpha_v": 1e-2,"entropy_coef": 0.001,"max_steps":20 } | l1=0.2</br>l2=0.4</br>l3=0.4</br>applicability_reward=30</br>hit_reward=50</br>hardening_threshold=0.2</br>harden_q_steps=30 | step_duration=5</br> ta_plan_threshold=0.3</br>ta_actor_max_plans=10</br>rl_num_episodes=10 |
...
- Libraries: absl-py (2.3.1), antlr4-python3-runtime (4.9.3),	anyio (4.9.0),	arrow (1.4.0),	attrs (25.4.0),	Brotli (1.1.0),	cabby (0.1.23),	certifi (2025.7.14),	cffi (1.17.1),	charset-normalizer (3.4.2),	click (8.2.1),	cloudpickle (3.1.2),	colorama (0.4.6),	colorlog (6.10.1),	colour (0.1.5),	commonmark (0.9.1),	contourpy (1.3.3),	cpe (1.3.1),	cssselect2 (0.8.0),	cybox (2.1.0.21),	cycler (0.12.1),	deepdiff (8.5.0),	distro (1.9.0),	dm-tree (0.1.9),	drawsvg (2.4.0),	et_xmlfile (2.0.0),	Farama-Notifications (0.0.4),	fastapi (0.116.1),	filelock (3.20.2),	fire (0.4.0),	fonttools (4.59.0),	fqdn (1.5.1),	fsspec (2025.12.0),	furl (2.1.4),	gitdb (4.0.12),	GitPython (3.1.46),	gymnasium (1.1.1),	h11 (0.16.0),	httpcore (1.0.9),	httpx (0.28.1),	idna (3.1),	importlib-metadata (3.3.0),	isoduration (20.11.0),	Jinja2 (3.1.6),	jiter (0.10.0),	joblib (1.5.3),	jsonpointer (3.0.0),	jsonschema (4.25.1),	jsonschema-specifications (2025.9.1),	kiwisolver (1.4.9),	lark (1.3.0),	libtaxii (1.1.119),	loguru (0.7.3),	lxml (6.0.2),	lz4 (4.4.5),	maec (4.1.0.17),	Markdown (3.8.2),	markdown-it-py (3.0.0),	MarkupSafe (3.0.2),	matplotlib (3.10.8),	mdurl (0.1.2),	mitreattack-python (4.0.2),	mixbox (1.0.5),	mpmath (1.3.0),	msgpack (1.1.2),	msgpack-numpy (0.4.8),	netaddr (1.3.0),	networkx (3.6.1),	numpy (2.2.3),	nvdlib (0.8.2),	openai (1.97.0),	openpyxl (3.1.5),	ordered-set (4.1.0),	orderedmultidict (1.0.1),	orderly-set (5.5.0),	ormsgpack (1.7.0),	packaging (25),	pandas (2.2.3),	pandas-stubs (2.2.3.250527),	pdfkit (1.0.0),	pillow (11.3.0),	platformdirs (4.3.8),	pluralizer (2.0.0),	pooch (1.8.2),	protobuf (6.33.2),	pyarrow (22.0.0),	pyattck (7.1.2),	pyattck-data (2.6.3),	pycountry (24.6.1),	pycparser (2.22),	pydantic (1.10.22),	pydyf (0.11.0),	Pygments (2.19.2),	pyparsing (3.2.3),	pyphen (0.17.2),	python-dateutil (2.9.0.post0),	pytz (2025.1),	PyYAML (6.0.2),	ray (2.53.0),	rdflib (7.1.4),	referencing (0.37.0),	requests (2.30.0),	rfc3339-validator (0.1.4),	rfc3986-validator (0.1.1),	rfc3987-syntax (1.1.0),	rich (12.6.0),	rpds-py (0.28.0),	scikit-learn (1.8.0),	scipy (1.16.3),	seaborn (0.13.2),	sentry-sdk (2.49.0),	shellingham (1.5.4),	simplejson (3.20.1),	six (1.17.0),	smmap (5.0.2),	sniffio (1.3.1),	starlette (0.47.2),	stix (1.2.0.11),	stix-edh (1.0.3),	stix2 (3.0.1),	stix2-elevator (4.1.7),	stix2-patterns (2.0.0),	stix2-validator (3.2.0),	stixmarx (1.0.8),	sympy (1.14.0),	tabulate (0.9.0),	taxii2-client (2.3.0),	tensorboardX (2.6.4),	termcolor (3.1.0),	threadpoolctl (3.6.0),	tinycss2 (1.4.0),	tinyhtml5 (2.0.0),	torch (2.9.1+cu130),	torchaudio (2.9.1+cu130),	torchvision (0.24.1+cu130),	tqdm (4.67.1),	typer (0.16.0),	types-pytz (2025.2.0.20251108),	typing_extensions (4.14.1),	tzdata (2025.1),	uri-template (1.3.0),	urllib3 (2.5.0),	uvicorn (0.35.0),	wandb (0.23.1),	weakrefmethod (1.0.3),	weasyprint (66),	webcolors (24.11.1),	webencodings (0.5.1),	win32_setctime (1.2.0),	wrapt (2.0.1),	xlsxwriter (3.2.5),	zipp (3.23.0), zopfli (0.2.3.post1)
