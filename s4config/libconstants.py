...
IND_TYPES={"Preventive":['vulnerability','vulnerability:name','x509-certificate:serial_number','windows-registry-key:key'],
           "Detective":['file:name','malware:name','email-addr:value','url:value','file:hashes.SHA256','artifact:payload_bin','x-crypto-address:value','process:name','process:mutexes[*]', 'process:command_line', 'process:mutexes*.name','rule', 'mutex:value', 'domain-name:value','mutex:name','network-traffic:extensions','x509-certificate:serial_number','network-traffic:user_agent',  'directory:path','file:hashes.imphash','network-traffic:dst_port', 'file:hashes.SHA1','file:parent_directory_ref.path','file:hashes', 'file:hashes.SHA-256', 'ipv4-addr:value','email-message:from_ref.value','network-traffic:extensions.http-request-ext.request_header.User-Agent','file:parent_directory_ref','file:path','file:hashes.MD5','network-traffic:extensions.http-request-ext.request_uri','network-traffic:extensions.http-request-ext.request_header.X-Not-Malware',],
